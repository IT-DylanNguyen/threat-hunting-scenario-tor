...
2. Install it silently: ```tor-browser-windows-x86_64-portable-14.0.9.exe```
...
## Related Queries:
```kql
// Installer name == tor-browser-windows-x86_64-portable-14.0.9.exe
...
DeviceProcessEvents
| where ProcessCommandLine contains "tor-browser-windows-x86_64-portable-14.0.9.exe  /S"
...
## Created By:
- **Author Name**: Dylan Nguyen
- **Author Contact**: https://www.linkedin.com/in/dylan-nguyen-it/
- **Date**: Aptil 14, 2025
